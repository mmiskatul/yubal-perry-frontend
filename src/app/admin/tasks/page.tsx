...
export default function AdminTasksPage() {
  ...
  const [dispatchList, setDispatchList] = React.useState([
    { time: '9:00 AM', title: 'Welcome Assessment', desc: '124 Tenants | Stage 1 | Schedule', status: 'COMPLETED', color: '#10b981', bg: '#e6fbf3', icon: <LuCircleCheck /> },
    { time: '11:30 AM', title: 'Residency Verification', desc: '42 Tenants | Stage 2 | Trigger', status: 'RUNNING', color: '#0a57e3', bg: '#eff6ff', icon: <LuCirclePlay /> },
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: '24px', borderBottom: '1px solid var(--border-color)', paddingBottom: '0px', marginBottom: '24px' }}>
        ...
        <div style={{ 
          ...
          {currentStep > 1 ? (
            <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#10b981', color: '#ffffff', fontSize: '0.675rem' }}><LuCircleCheck /></span>
          ) : (
            <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '20px', height: '20px', borderRadius: '50%', backgroundColor: '#0a57e3', color: '#ffffff', fontSize: '0.725rem' }}>1</span>
          )}
  ...
  return (
    <div style={{ padding: '0px' }} className="animate-fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '32px' }}>
        ...
        {/* Active Schedules */}
        <div style={{ backgroundColor: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '20px 24px', boxShadow: 'var(--shadow-sm)', textAlign: 'left', position: 'relative' }}>
          ...
          <h2 style={{ fontSize: '1.6rem', fontWeight: 800, color: 'var(--text-primary)', margin: '8px 0 4px 0' }}>
            24 <span style={{ fontSize: '0.8rem', color: '#10b981', fontWeight: 700, marginLeft: '4px' }}>+2 New</span>
          </h2>
        </div>
        ...
        <div style={{ backgroundColor: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '20px 24px', boxShadow: 'var(--shadow-sm)', textAlign: 'left', position: 'relative' }}>
          ...
          <span style={{ position: 'absolute', right: '20px', top: '20px', color: 'var(--text-muted)', fontSize: '1rem', cursor: 'pointer' }}><LuInfo /></span>
          <h2 style={{ fontSize: '1.6rem', fontWeight: 800, color: 'var(--text-primary)', margin: '8px 0 4px 0' }}>
            12 <span style={{ fontSize: '0.75rem', color: '#0a57e3', fontWeight: 700, marginLeft: '4px' }}>Priority</span>
          </h2>
        </div>

        {/* Completion Rate (Alert state) */}
        <div style={{ backgroundColor: '#fff5f5', border: '1px solid #fee2e2', borderRadius: '12px', padding: '20px 24px', boxShadow: 'var(--shadow-sm)', textAlign: 'left', position: 'relative' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <span style={{ fontSize: '0.65rem', padding: '2px 8px', borderRadius: '4px', backgroundColor: '#eff6ff', color: '#0a57e3', fontWeight: 700 }}>In Progress</span>
              <span style={{ fontSize: '0.65rem', padding: '2px 8px', borderRadius: '4px', backgroundColor: '#e6fbf3', color: '#10b981', fontWeight: 700 }}>Scoring Impact</span>
            </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '24px' }}>
            <span style={{ fontSize: '0.725rem', padding: '3px 8px', borderRadius: '6px', backgroundColor: '#f1f5f9', color: 'var(--text-secondary)', fontWeight: 600 }}>Stage 2 - Check-In Cycle</span>
            <span style={{ fontSize: '0.725rem', padding: '3px 8px', borderRadius: '6px', backgroundColor: '#f1f5f9', color: 'var(--text-secondary)', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '4px' }}><LuCalendar /> Day 1 of 7</span>
            <span style={{ fontSize: '0.725rem', padding: '3px 8px', borderRadius: '6px', backgroundColor: '#f1f5f9', color: 'var(--text-secondary)', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '4px' }}><LuFileText /> Text Response</span>
            <span style={{ fontSize: '0.725rem', padding: '3px 8px', borderRadius: '6px', backgroundColor: '#fff5f5', color: '#ef4444', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: '4px' }}><span style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#ef4444' }} /> High Priority</span>
          ...
          >
            ...
            <span style={{ fontSize: '#0.75rem', fontWeight: 700, color: '#f59e0b', marginTop: '16px', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
              {['Greenfield Residences – Unit 3A', 'Skyline Properties – Unit 7B', 'Harbor View Estates – Unit 12C'].map((tag, i) => (
                <span key={i} style={{ fontSize: '0.75rem', padding: '4px 12px', borderRadius: '6px', backgroundColor: '#eff6ff', color: '#0a57e3', fontWeight: 700 }}>
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div style={{ display: 'flex', gap: '12px', borderTop: '1px solid var(--border-color)', paddingTop: '20px' }}>
            <button 
              className="premium-btn premium-btn-primary" 
              style={{ '--btn-color': '#0a57e3', padding: '8px 16px', borderRadius: '6px', fontSize: '0.75rem', fontWeight: 700, display: 'inline-flex', gap: '6px' } as React.CSSProperties}
        ...
        >
          ...
          <div style={{ padding: '0 24px 16px 24px', borderBottom: '1px solid var(--border-color)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h4 style={{ fontSize: '0.9rem', fontWeight: 800, color: 'var(--text-primary)', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
              <LuSend style={{ fontSize: '1rem', color: '#0a57e3' }} /> Today's Dispatch
            </h4>
            <a href="#" style={{ fontSize: '0.75rem', color: '#0a57e3', fontWeight: 700, textDecoration: 'none' }} onClick={()=>alert('Sandbox details pipeline index logs')}>View All</a>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', padding: '16px 24px 0 24px', gap: '16px' }}>
            {dispatchList.map((d, i) => (
              ...
              >
                <div>
                  <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#0a57e3', display: 'block' }}>{d.time}</span>
      ...
      {/* Bottom Panel Card: Cognitive Load Pilot v2 Draft (Screenshot 1) */}
      <div 
        style={{
      ...
      >
        <div style={{ flex: 1.5 }}>
          ...
          <div style={{ display: 'flex', gap: '6px', marginBottom: '12px' }}>
            <span style={{ fontSize: '0.625rem', padding: '2px 8px', borderRadius: '4px', backgroundColor: '#e2e8f0', color: 'var(--text-secondary)', fontWeight: 700, letterSpacing: '0.05em' }}>DRAFT</span>
            <span style={{ fontSize: '0.625rem', padding: '2px 8px', borderRadius: '4px', backgroundColor: '#e2e8f0', color: 'var(--text-secondary)', fontWeight: 700, letterSpacing: '0.05em' }}>PSYCHOMETRIC</span>
          </div>
        ...
        <div className="modal-overlay" onClick={() => setIsCreateModalOpen(false)}>
          <div className="modal-content animate-fade-in" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              {currentStep === 1 && (
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: '#eff6ff', border: '1px solid #dbeafe', borderRadius: '8px', padding: '12px 16px', marginBottom: '20px' }}>
                    <span style={{ color: '#0a57e3', display: 'flex', fontSize: '1rem' }}><LuInfo /></span>
                    <span style={{ fontSize: '0.75rem', color: '#1e40af', lineHeight: '1.4', textAlign: 'left' }}>
                ...
                <div style={{ textAlign: 'left' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '24px', marginTop: '6px', marginBottom: '20px' }}>
                    <div>
                      ...
                      <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', display: 'block', marginTop: '6px' }}>
                        Tenant will see: <span style={{ color: '#0a57e3', fontWeight: 600 }}>Day {dayInCycle} of {totalDays}</span>
                      </span>
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    {['High', 'Medium', 'Low'].map((p) => {
                      ...
                      if (priority === p) {
                        if (p === 'High') {
                          activeStyle = { border: '1.5px solid #ef4444', color: '#ef4444', backgroundColor: '#fff5f5' };
                        } else if (p === 'Medium') {
                          activeStyle = { border: '1.5px solid #eab308', color: '#eab308', backgroundColor: '#fffbeb' };
                        } else {
                          activeStyle = { border: '1.5px solid #10b981', color: '#10b981', backgroundColor: '#e6fbf3' };
                        }
                      }
                      return (
                        <button 
              ...
              {currentStep === 3 && (
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: '#e6fbf3', border: '1px solid #c6f6e5', borderRadius: '8px', padding: '12px 16px', marginBottom: '20px' }}>
                    <span style={{ color: '#10b981', display: 'flex', fontSize: '1.1rem' }}><LuUserPlus /></span>
                    <span style={{ fontSize: '0.75rem', color: '#065f46', lineHeight: '1.4', textAlign: 'left' }}>
                      Task <strong>"{taskTitle || 'azcaecsac'}"</strong> will be sent to selected tenants' portals immediately upon creation.
                    </span>
                  </div>

                  <div style={{ padding: '20px', border: '1px solid var(--border-color)', borderRadius: '10px', backgroundColor: '#ffffff', textAlign: 'left' }}>
            ...
            <div className="modal-footer">
              ...
              {currentStep < 3 ? (
                <button 
                  type="button"
                  className="premium-btn premium-btn-primary"
                  style={{ '--btn-color': '#0a57e3', padding: '8px 20px', borderRadius: '6px', fontSize: '0.8rem', display: 'inline-flex', alignItems: 'center', gap: '4px' } as React.CSSProperties}
                  onClick={() => {
                ...
                <button 
                  type="button"
                  className="premium-btn premium-btn-primary"
                  style={{ '--btn-color': '#0a57e3', padding: '8px 20px', borderRadius: '6px', fontSize: '0.8rem', display: 'inline-flex', alignItems: 'center', gap: '6px' } as React.CSSProperties}
      ...
      <style>{`
        ...
        .modal-input:focus {
          border-color: #0a57e3;
          box-shadow: 0 0 0 3px rgba(10, 87, 227, 0.15);
        }
        .modal-textarea {
          width: 100%;
          height: 100px;
        ...
        >
          ...
          >
            ...
            <button 
              type="button"
              className="premium-btn premium-btn-primary"
              style={{ '--btn-color': '#0a57e3', padding: '10px 24px', borderRadius: '8px', fontSize: '0.825rem', width: '100%', fontWeight: 700 } as React.CSSProperties}
              onClick={() => setCustomAlert(null)}
            >
              Dismiss
            </button>
