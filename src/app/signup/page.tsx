      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'left', marginBottom: '28px' }}>
            <h1 style={{ fontSize: '2.1rem', fontWeight: 800, color: '#0f172a', margin: '0 0 6px 0' }}>Sign Up</h1>
            <p style={{ margin: 0, fontSize: '0.88rem', color: '#64748b', fontWeight: 600 }}>
              Already have an account?{' '}
              <Link href="/login" style={{ color: '#e57373', textDecoration: 'none', fontWeight: 700 }}>
                Sign in
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.825rem' }}>
              ...
              <Link href="#" style={{ color: '#0f172a', textDecoration: 'underline', fontWeight: 700 }}>
                Forgot Password?
              </Link>
            </div>
