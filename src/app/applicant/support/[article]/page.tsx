        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button
            ...
            style={{
              ...
              borderRadius: '8px',
              border: '1.5px solid',
              borderColor: voted === 'YES' ? 'var(--brand-color)' : 'var(--border-color)',
              backgroundColor: voted === 'YES' ? 'var(--brand-light)' : 'var(--bg-secondary)',
              color: voted === 'YES' ? 'var(--brand-color)' : 'var(--text-primary)',
              fontWeight: 700,
              fontSize: '0.85rem',
              cursor: 'pointer',
              transition: 'all 0.2s'
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '8px',
              border: '1.5px solid',
              borderColor: voted === 'NO' ? 'var(--color-alert-border)' : 'var(--border-color)',
              backgroundColor: voted === 'NO' ? 'var(--color-alert-light)' : 'var(--bg-secondary)',
